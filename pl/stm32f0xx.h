...
#define USE_STDPERIPH_DRIVER            // Это говорит о том что мы используем стандартный драйвер переферии
#define STM32F030                       // Это наш микроконтроллер
#define HSE_VALUE ((uint32_t)8000000)   // Это значение кварцевого резонатора на плате
#ifdef __cplusplus
 extern "C" {
#endif 
